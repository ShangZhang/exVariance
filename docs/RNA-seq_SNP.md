...
RNA-seq single nucleotide polymorphism analysis related examples can be found in `demo` directory with the following structure:
...
<div align="center"><img alt="rulegraph_RNA_seq_SNP" style="width:500px;" src="imgs/exVarianceRNA_seq_SNP.png"/></div>
